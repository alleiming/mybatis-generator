...
public class MyCommentGenerator extends DefaultCommentGenerator {
    ...
    /*
     * @Override public void addClassComment(InnerClass innerClass,
     * IntrospectedTable introspectedTable) { // 类注释，不管用 String shortName =
     * innerClass.getType().getShortName(); innerClass.addJavaDocLine("
     *//**
     ...
     * introspectedTable.getFullyQualifiedTable()); // addJavadocTag(innerClass,
     * false); innerClass.addJavaDocLine("
     */
    /*
     * "); }
     */
    ...
    public void addGetterComment(Method method, IntrospectedTable introspectedTable,
        ...
        /*
         * StringBuilder sb = new StringBuilder(); method.addJavaDocLine("
         *//**
         * "); //$NON-NLS-1$ // method.addJavaDocLine(
         ...
         * //$NON-NLS-1$ sb.setLength(0); sb.append(" * @return ");
         * //$NON-NLS-1$ sb.append(introspectedTable.getFullyQualifiedTable());
         * sb.append('.'); sb.append(introspectedColumn.getActualColumnName());
         * sb.append(", "); sb.append(introspectedColumn.getRemarks());
         * method.addJavaDocLine(sb.toString()); // addJavadocTag(method,
         * false); method.addJavaDocLine("
         */
        /* "); //$NON-NLS-1$ */
    }
    ...
    public void addSetterComment(Method method, IntrospectedTable introspectedTable,
         ...
         * sb.append('.'); sb.append(introspectedColumn.getActualColumnName());
         * method.addJavaDocLine(sb.toString()); method.addJavaDocLine(" *");
         * //$NON-NLS-1$ Parameter parm = method.getParameters().get(0);
         * sb.setLength(0); sb.append(" * @param "); //$NON-NLS-1$
         * sb.append(parm.getName()); sb.append(" the value for ");
         * //$NON-NLS-1$ sb.append(introspectedTable.getFullyQualifiedTable());
         * sb.append('.'); sb.append(introspectedColumn.getActualColumnName());
         * sb.append(", "); sb.append(introspectedColumn.getRemarks());
         * method.addJavaDocLine(sb.toString()); // addJavadocTag(method,
    ...
    public void addComment(XmlElement xmlElement) {
         ...
         * TextElement(sb.toString())); // xmlElement // .addElement(new
         * TextElement( //
         * "  This element is automatically generated by MyBatis Generator, do not modify."
         * )); //$NON-NLS-1$ // String s = getDateString(); // if (s != null) {
         * // sb.setLength(0); // sb.append("  This element was generated on ");
         * //$NON-NLS-1$ // sb.append(s); // sb.append('.'); //
